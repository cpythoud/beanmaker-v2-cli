...
class BeanRelationshipCommand implements Callable<Integer> {
    ...
    @Option(names = "--associated-table", paramLabel = "<table>", description = "specify associated table")
    String table;

    @Option(names = "--sql-id-field", paramLabel = "<id_field>", description = "specify id field in associated table")
